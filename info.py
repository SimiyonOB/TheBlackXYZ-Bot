...
# Bot information
SESSION = environ.get('SESSION', 'GoAT_07_bot')
API_ID = int(environ.get('API_ID', '26417731'))
API_HASH = environ.get('API_HASH', '15fd59f3dcf74a5db359621517efa84e')
BOT_TOKEN = environ.get('BOT_TOKEN', "7580348223:AAF-bXwJqNv0FVg4zjjT3zt7-Thi2rQgGwo")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002175198774'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6779671330').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002450752473') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002260496904')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information database 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://GOATKING:GOATKING@cluster0.3brj9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Links 💸
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/goatmoviegiver')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+u9913OXkO1VkOWI1')
TUTORIAL = environ.get('TUTORIAL', '')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', '')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '') # Support Chat Links Without https:// or @
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://GOATKING:GOATKING@cluster0.3brj9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '@publicdatabasefor') # Public Channel Username Without @ and Bot Is Admin In Your Channel.
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://GOATKING:GOATKING@cluster0.3brj9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
...
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>- ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs - \n\n- 2ʀs - 1 ᴡᴇᴇᴋ.[ Gold 🥇]\n- 10ʀs - 1 ᴍᴏɴᴛʜs.[ Silver🥈]\n- 30ʀs - 3 ᴍᴏɴᴛʜs.[ Platinum🥉]\n- 60ʀs - 6 ᴍᴏɴᴛʜs.[ Dimond 1️⃣]\n- 90ʀs - 9 ᴍᴏɴᴛʜs.[ Dimond 2️⃣]\n- 100ʀs - 11 ᴍᴏɴᴛʜs.[ Dimond 3️⃣]\n- 150ʀs - 15 ᴍᴏɴᴛʜs.[ Legend Pack 👑]\n\n🎁 ᴘʀᴇᴍɪᴜᴍ ғᴇᴀᴛᴜʀᴇs 🎁\n\n✯ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪғʏ\n✯ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ\n✯ ᴅɪʀᴇᴄᴛ ғɪʟᴇs\n✯ ᴀᴅ-ғʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ\n✯ ʜɪɢʜ-sᴘᴇᴇᴅ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ\n✯ ᴍᴜʟᴛɪ-ᴘʟᴀʏᴇʀ sᴛʀᴇᴀᴍɪɴɢ ʟɪɴᴋs\n✯ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs\n✯ ꜰᴜʟʟ ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ\n✯ ʀᴇǫᴜᴇsᴛ ᴡɪʟʟ ʙᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ 1ʜ ɪꜰ ᴀᴠᴀɪʟᴀʙʟᴇ\n\n✨ ᴜᴘɪ ɪᴅ - <code>stv73033@oksbi</code>\n\nᴄʟɪᴄᴋ ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ /myplan\n\n💢 ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ - <code>@mustangott</code> \n\n‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ</b>')
